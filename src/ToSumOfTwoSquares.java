...
//        log.info(findSumOfTwoSquares(n).toString());
    ...
    public static void pressButton1() {
        ...
        if (exist) {
            System.out.format("Number %d can be represented as sum of two squares\n\n",m);
        } else {
            System.out.format("Number %d cannot be represented as sum of two squares\n\n",m);
        }
    }
    ...
    public static void pressButton2() {
        ...
        if (squares.isEmpty()) {
            System.out.println("Number cannot be represented as sum of two squares\n");
        } else {
    ...
    public static void outputMenu() {
        System.out.println("1 - check if number can be represented as sum of two squares\n" +
